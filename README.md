...
상품 전시, 주문, 결제, 재고, 생산 입고, 바코드, 출고, 송장, 배송, 반품, 권한, 감사 로그까지 실제 운영에서 이어지는 흐름을 축소 구현하는 것을 목표로 합니다. 현재 기준 구현 상태와 로드맵은 `v0.6.9` 기준으로 정리되어 있습니다.

> 최신 구현 현황과 상세 버전 계획은 [docs/README.md](./docs/README.md)에서 시작하세요.
...
상세 로드맵은 [docs/PRODUCT_ROADMAP.md](./docs/PRODUCT_ROADMAP.md), [docs/LONG_TERM_ROADMAP.md](./docs/LONG_TERM_ROADMAP.md), [docs/VERSION_PLAN.md](./docs/VERSION_PLAN.md)를 기준으로 합니다.
...
- [현재 구현 현황](./docs/CURRENT_STATE.md)
- [버전 계획표](./docs/VERSION_PLAN.md)
- [제품 로드맵](./docs/PRODUCT_ROADMAP.md)
- [장기 로드맵](./docs/LONG_TERM_ROADMAP.md)
- [API 명세](./docs/API.md)
