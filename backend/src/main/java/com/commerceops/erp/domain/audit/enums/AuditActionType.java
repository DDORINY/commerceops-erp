...
public enum AuditActionType {
    ...
    REVENUE_RECOGNIZED,
    REFUND_ACCOUNTING_RECOGNIZED,
    RETURN_FEE_ACCOUNTING_RECOGNIZED,
    SHIPPING_COST_ACCOUNTING_RECOGNIZED,
    SETTLEMENT_BATCH_CREATED,
    SETTLEMENT_BATCH_CLOSED,
    ACCOUNTING_TRANSACTION_DUPLICATE_SKIPPED,
    PERMISSION_DENIED
}
