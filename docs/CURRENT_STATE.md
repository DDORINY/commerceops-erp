...
문서 정합성 기준: 2026-07-07에 루트 `README.md`, `docs/PRODUCT_ROADMAP.md`, `docs/V0.7_ACCOUNTING_SETTLEMENT_PLAN.md`의 깨진 한글과 오래된 로드맵 단계를 `v0.6.9` 실제 완료 상태 및 `v0.7` 이후 계획 기준으로 재정리했다.

AI 개발/학습/배포 전략 문서: 2026-07-07에 `docs/AI_DEVELOPMENT_DEPLOYMENT_PLAN.md`를 추가해 v0.8/v0.9 AI 기능의 `ai/` 디렉터리 구조, Git 포함/제외 기준, 학습/추론 분리, AWS EC2 1대 서버 배포 전략, LLM 비용 제한 정책을 문서화했다.
...
| v0.7 회계/정산 이관 | 준비 완료. 배송비, 환불 배송비, 택배비 매입/매출, 출고 완료 기준 매출 확정 후보를 `docs/V0.7_ACCOUNTING_SETTLEMENT_PLAN.md`에 정리 |
...
- [AI_DEVELOPMENT_DEPLOYMENT_PLAN.md](./AI_DEVELOPMENT_DEPLOYMENT_PLAN.md): v0.8/v0.9 AI 개발/학습/추론/배포 전략.
...
- [V0.5_INVENTORY_BARCODE_PLAN.md](./V0.5_INVENTORY_BARCODE_PLAN.md): v0.5 재고관리/생산 입고/바코드 자동화 계획과 구현 기준.
- [V0.6_DISTRIBUTION_SHIPPING_PLAN.md](./V0.6_DISTRIBUTION_SHIPPING_PLAN.md): v0.6 유통관리/송장/배송 계획과 구현 기준.
- [V0.7_ACCOUNTING_SETTLEMENT_PLAN.md](./V0.7_ACCOUNTING_SETTLEMENT_PLAN.md): v0.7 회계관리 고도화 예정 범위.
