...
- [ ] `v0.4.8-business-terms-settings` 브랜치 생성
- [ ] 사업자 설정 저장 모델 구현
- [ ] 약관/정책 버전 모델 구현
- [ ] business/terms/settings Flyway migration 추가
- [ ] 관리자 설정 저장 API 구현
- [ ] 공개 약관/정책 조회 API 구현
- [ ] `/admin/settings` 저장 화면 구현
- [ ] 변경 작업 audit log 기록
- [ ] 관련 문서와 체크리스트 갱신
- [ ] frontend lint/build 통과
- [ ] backend test 통과
- [ ] main 병합 및 `v0.4.8` 태그 생성

v0.4.9 검증 중 원격 fetch 기준으로 v0.4.8 태그, 체크리스트, business/terms/settings 구현이 확인되지 않았다.
...
- [ ] frontend lint/build 통과
- [ ] backend test 통과
- [ ] v0.4.8 선행 완료 후 main 병합 및 `v0.4.9` 태그 생성
