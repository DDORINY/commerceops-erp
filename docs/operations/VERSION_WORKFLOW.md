...
- 버전 범위와 체크리스트: `docs/plans/VERSION_PLAN.md`
- 작업 규칙: `docs/operations/VERSION_WORKFLOW.md`
- 기능 상세: `docs/features/`
- API 변경: `docs/architecture/API_REFERENCE.md`
- DB 변경: `docs/architecture/DATABASE_SCHEMA.md`
- 현재 상태: `docs/operations/CURRENT_STATE.md`
